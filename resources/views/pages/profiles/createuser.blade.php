        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ __('Alta de usuario') }}</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">
                            {{ __('Ingrese datos del alta')}}</span>
                    </div>
                    <!--end::Search Form-->
                </div>
                <!--end::Details-->
                                ...
                                <div class="wizard-steps">
                                    ...
                                    <div class="wizard-step" data-wizard-type="step">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">Rol de Usuario</div>
                                                <div class="wizard-desc">Rol &amp; Configuración</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wizard-step" data-wizard-type="step">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">Domicilio</div>
                                                <div class="wizard-desc">Dirección del alta</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wizard-step" data-wizard-type="step">
                                        <div class="wizard-wrapper">
                                            ...
                                            <div class="wizard-label">
                                                <div class="wizard-title">Envio</div>
                                                <div class="wizard-desc">Detalle Alta</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                        <div class="col-xl-12 col-xxl-10">
                                            <!--begin::Wizard Form-->
                                            <form action="{{url('usuarios')}}" class="form" id="kt_form" method="POST">
                                                @csrf
                                                <div class="row justify-content-center">
                                                    <div class="col-xl-9">
                                                        <!--begin::Wizard Step 1-->
                                                        <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                            <h5 class="text-dark font-weight-bold mb-10">Datos del Alta:</h5>
                                                            <!--begin::Group-->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input  onkeyup="PasarValor() "id="nombre" class="form-control form-control-solid form-control-lg" name="name" type="text" value="" />
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                          ...
                                                          {{--   <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        ...
                                                                        <input 
                                                                        onkeyup="PasarValor() "id="telefono"
                                                                        
                                                                        type="text" class="form-control form-control-solid form-control-lg" name="phone" value="5678967456" placeholder="Phone" />
                                                                    </div>
                                                                    <span class="form-text text-muted">Ingrese un número válido de (e.j: 011 36185689).</span>
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        ...
                                                                        onkeyup="PasarValor()"
                                                                        id="email"
                                                                         type="text" class="form-control form-control-solid form-control-lg" name="email" value="" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            {{-- <div class="form-group row">
                                                                <label for='password' class="col-xl-3 col-lg-3 col-form-label">Pass provisoria</label>
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="input-group input-group-solid input-group-lg">
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="password" placeholder="Username" value="loop" />
                                                        ...
                                                        <div class="my-5 step" data-wizard-type="step-content">
                                                            <h5 class="text-dark font-weight-bold mb-10 mt-5">Rol de usuario</h5>
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-xl-3 col-lg-3">Rol</label>
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <select class="form-control form-control-lg form-control-solid" name="rol"
                                                                    onkeyup="PasarValor()"
                                                                        id="rol"
                                                           ...
                                                           {{--  <div class="form-group row">
                                                            ...
                                                            <h5 class="text-dark font-weight-bold mb-10">Lineas de Credito</h5>
                                                            <!--begin::Group-->
                                                            <div class="form-group row">
                                                                <label class="col-form-label col-xl-3 col-lg-3">Linea de Credito</label>
                                                                <div class="col-xl-9 col-lg-9">
                                                                    <select class="form-control form-control-lg form-control-solid" name="rol"
                                                                    onkeyup="PasarValor()"
                                                                        id="rol"
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >Selecione una linea de credito...</option>
                                                                        @foreach ( $roles as $key => $value)
                                                                        <option value="{{$value}}">{{$value}}</option>
                                                      ...
                                                      {{--       <div class="form-group row">
                                                        ...
                                                        <!--begin::Wizard Step 3-->
                                                        <div class="my-5 step" data-wizard-type="step-content">
                                                            <h5 class="mb-10 font-weight-bold text-dark">Domicilio</h5>
                                                            <!--begin::Group-->
                                                            <div class="form-group">
                                                                ...
                                                                <span class="form-text text-muted">Ingrese dirección.</span>
                                                            </div>
                                                            <!--end::Group-->
                                                            <!--begin::Group-->
                                                            <div class="form-group">
                                                                <label>Direccion alternativa</label>
                                                                ...
                                                                <span class="form-text text-muted">Campo no obligatorio.</span>
                                                            </div>
                                                            <!--begin::Row-->
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span class="form-text text-muted">Ingrese el código postal</span>
                                                                    </div>
                                                                </div>
                                                                <!--end::Group-->
                                                                <!--begin::Group-->
                                                                <div class="col-xl-6">
                                                                    <div class="form-group">
                                                                        <label>Ciudad</label>
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="city" placeholder="City" value="Capital Federal" />
                                                                        <span class="form-text text-muted">Ingrese ciudad.</span>
                                                                    </div>
                                                                </div>
                                                                <!--end::Group-->
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="state" placeholder="State" value="CABA" />
                                                                        <span class="form-text text-muted">Ingrese localidad.</span>
                                                                    </div>
                                                                    <!--end::Group-->
                                                                </div>
                                                                <div class="col-xl-6">
                                                        ...
                                                        <!--begin::Wizard Step 4-->
                                                        <div class="my-5 step" data-wizard-type="step-content">
                                                            <h5 class="mb-10 font-weight-bold text-dark">Detalle de Alta</h5>
                                                            <!--begin::Item-->
                                                            <div class="border-bottom mb-5 pb-5">
                                                                <div class="font-weight-bolder mb-3">Datos de cuenta:</div>
                                                                <div class="line-height-xl">
                                                                    Nombre: <span id="nombreRender"></span>
                                                                <br />
                                                                Telefono: <span id="telefonoRender"></span>
                                                             
                                                                <br />
                                                                
                                                                Email: <span id="emailRender"></span>
                                                            </div>
                                                            ...
                                                            <!--begin::Item-->
                                                            <div class="border-bottom mb-5 pb-5">
                                                                <div class="font-weight-bolder mb-3">Rol de Usuario</div>
                                                                <div class="line-height-xl">

                                                                    Rol: <span id="rolRender"></span>
                                                                <br />
...
@section('scripts')
    ...
    <script src="{{ asset('js/pages/custom/user/renderalta.js') }}" type="text/javascript"></script>
@endsection
