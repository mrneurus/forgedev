                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7 my-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <h6 class="text-dark font-weight-bold mb-10">Información de la cuenta</h6>
                                        </div>
                                    </div>
                                    <!--end::Row-->
                                    <!--begin::Group-->
                                   ...
                                   {{--  <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input readonly class="form-control form-control-lg form-control-solid" type="text" value="{{$usuario->getRoleNames()->implode(', ')  }}">
