...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Listado Lineas de Credito</span>
        ...
        <div class="card-toolbar">
            ...
            <span class="svg-icon svg-icon-md svg-icon-white">
               ...
               {{--  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <!--end::Svg Icon-->
            </span>Crear lineas de Crédito</a>
        </div>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                <thead>
                    <tr class="text-left">
                       ...
                       {{--  <th class="pr-0" style="width: 50px">Nombre</th> --}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$lc->name}}</a>
