...
<div class="card card-custom bg-gray-100 {{ @$class }}">
    ...
    <div class="card-header border-0 bg-danger py-5">
        <h3 class="card-title font-weight-bolder text-white">Administrador</h3>
        ...
        <div class="card-spacer mt-n25">
            ...
            <div class="row m-0">
                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="{{ url('/lineas-credito') }}"" class="text-warning font-weight-bold font-size-h6">
                        Lineas de crédito
                    </a>
                </div>
                <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                    {{ Metronic::getSVG("media/svg/icons/Communication/Add-user.svg", "svg-icon-3x svg-icon-primary d-block my-2") }}
                    <a href="{{ url('usuarios/create') }}" class="text-primary font-weight-bold font-size-h6 mt-2">
                        {{ __('Alta de usuario') }}
                    </a>
                </div>
            </div>
            ...
            <div class="row m-0">
                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                    ...
                    <a href="{{ url('usuarios') }}" class="text-danger font-weight-bold font-size-h6 mt-2">
                        Edicion de usuarios
                    </a>
                </div>
